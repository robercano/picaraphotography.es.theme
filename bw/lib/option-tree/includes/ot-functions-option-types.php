...
if ( ! function_exists( 'ot_type_bw_import_data' ) ) {
  ...
  function ot_type_bw_import_data( $args = array() ) {
    ...
    if(get_option( 'bw_demo_was_installed', false ) == false) {
		echo '<a href="#" class="bw-import-btn">' . __( 'Import demo content', 'option-tree' ) . '</a>';
	}
    ...
    echo '<p class="bw-import-success ' . ( (get_option( 'bw_demo_was_installed', false ) == true) ? 'visible' : '' ) . '">' . __( 'Demo content successfully imported', 'option-tree' ) . '</p>';
    echo '</div>';
...
if ( ! function_exists( 'ot_type_bw_on_off' ) ) {
  ...
  function ot_type_bw_on_off( $args = array() ) {
	...
	echo '<label class="bw-on-off" href="#" >'.
			'<input type="checkbox" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="1" ' . ( isset( $field_value ) ? checked( $field_value, 1, false ) : '' ) . ' />';
		 '</label>';
    echo '</div>';
